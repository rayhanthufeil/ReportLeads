...
<div style=";margin-left: 18%;padding-top: 122px" class="flex">
  <div style="width: 100%;  opacity: inherit;">
    ...
    <form action="print-OLD.php" method="POST">
    <div>
    
    <div class="form-group" align="center">
    <label>From Date</label>
    <input type="date" name="from_date" class="form-control"  style="width: 300px">
    </div>

    <div class="form-group" align="center">
    <label>Until Date</label>
    <input type="date" name="until_date" class="form-control"  style="width: 300px">
  </div>
    ...
    <input type="submit" value="Print" style="width: 100px" class="btn btn-success" style="height: 50px">
    </div>
