  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel" style="width: 1050px; ">
    ...
    <div class="carousel-inner" style="height: 420px;">
      <div class="item active">
        <img src="2016-Ford-Focus-RS-RX-V3-1536.jpg" alt="Semangat" style="width:100%; height: 420px;">
      </div>

      <div class="item">
        <img src="chicago.jpg" alt="Semangat" style="width:100%;">
      </div>
    
      <div class="item">
        <img src="ny.jpg" alt="Semangat" style="width:100%;">
      </div>
    </div>
