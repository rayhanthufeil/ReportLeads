...
<div style=";margin-left: 18%;padding-top: 122px" class="flex">
  <div style="width: 100%;  opacity: inherit;">
    ...
    <form action="action_notic.php" method="POST">
    <div>
    <div class="form-group" align="center">
    <label>Notification</label>
    <input type="hidden" value="1" name="id_notic">
    <textarea rows="10" name="message" class="form-control" placeholder="Input Notification In Here"></textarea><br>
    <input type="submit" value="Submit" style="width: 100px" class="btn btn-success" style="height: 300px">
    </div>
