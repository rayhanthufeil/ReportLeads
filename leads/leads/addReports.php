...
<div style=";margin-left: 18%;padding-top: 122px" class="flex">
  <div style="width: 100%;  opacity: inherit;">
    ...
    <form action="Action_Report.php" method="POST">
    <div>
    ...
    <tr>
        <td>
            ...
            <input type="text" name="nama_klien" class="form-control" placeholder="Nama Klien" style="width: 300px">
        </td>
        <td>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </td>
        <td>
            ...
            <input type="text" name="nama_perusahaan" class="form-control" placeholder="Nama Perusahaan" style="width: 300px">
        </td>
    <tr>    
    </table>
    </div>
    ...
    <tr>
        <td>
            <label>Telepon</label>
            <input type="text" name="no_telp" class="form-control" placeholder="Telepon" style="width: 300px">
        </td>
        <td>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </td>
        <td>
            <label>Email</label>
            <input type="text" name="email" class="form-control" placeholder="Email" style="width: 300px">
        </td>
    </tr>
    </table>
    </div>
    ...
    <tr>
        <td>
            ...
            <input list="referensi" name="referensi" class="form-control" placeholder="Referensi" style="width: 300px">
        ...
        <td>
            <label>Visit</label>
            <input type="date" name="tanggal_visit" class="form-control"  style="width: 300px">
        </td>
    </tr>
    </table>
    </div>
    ...
    <tr>
        <td>
            <label>Event</label>
            <input type="date" name="tanggal_event" class="form-control"  style="width: 300px">
        </td>
        <td>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </td>
        <td>
            <label>Pax</label>
            <input type="text" name="jumlah_pax" class="form-control" list="pax" placeholder="Pax" style="width: 300px">
        </td>
        </table>
        </div>
    ...
    <input list="kategori" name="kategori_event" class="form-control" placeholder="Kategori" style="width: 300px">
        ...
        <td>
            <label>Sales</label>
            <input list="sales" name="sales" class="form-control" placeholder="Sales" style="width: 300px">
            <datalist id="sales">
                <option value="Oke">
                <option value="Desi">
                <option value="Very">
    ...
    <label>Progres</label>
    <input list="progres" name="progres" class="form-control" placeholder="Progres" style="width: 300px">
        <datalist id="progres">
